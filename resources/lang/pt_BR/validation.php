...
return [
    ...
    */
    ...
    'password' => [
        ...
        'symbols' => 'O campo :attribute deve conter pelo menos um símbolo (ex: @, #, $, %, !, etc).',
        'uncompromised' => 'O :attribute fornecido apareceu em vazamento de dados. Por favor, escolha um :attribute diferente.',
    ],
    ...
    | convenção "attribute.rule" para nomear as linhas. Isso ajuda a especificar rapidamente
