        ...
        <div class="max-w-md w-full">
            <div class="bg-white rounded-xl shadow-2xl p-6 md:p-8">
                <div class="text-center mb-6">
                    ...
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Ãrea Segura</h1>
                    <p class="text-sm text-gray-600">Esta Ã© uma Ã¡rea segura da aplicaÃ§Ã£o. Por favor, confirme sua senha antes de continuar.</p>
                </div>
                ...
                <div class="mt-6 p-4 bg-amber-50 border-l-4 border-amber-500 rounded-lg">
                    <div class="flex items-start">
                        ...
                        <p class="text-sm text-amber-800">
                            <strong>AtenÃ§Ã£o:</strong> Esta confirmaÃ§Ã£o Ã© necessÃ¡ria para garantir a seguranÃ§a de suas informaÃ§Ãµes.
                        </p>
                    </div>
                </div>
            </div>
