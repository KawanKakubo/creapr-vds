        ...
        <div class="max-w-md w-full">
            ...
            <div class="bg-white rounded-xl shadow-2xl p-6 md:p-8">
                ...
                <div class="text-center mb-6">
                    ...
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Acesso de Município</h1>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="text-sm text-blue-800">
                                <strong>Novo por aqui?</strong> Faça sua <a href="{{ route('manifestacao.show') }}" class="underline font-semibold hover:text-blue-900">manifestação de interesse</a> para receber suas credenciais de acesso.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4 text-center">
                    <p class="text-sm text-gray-600">
                        É um administrador? <a href="{{ route('admin.login') }}" class="text-red-600 font-semibold hover:text-red-700 underline">Acesse o login administrativo</a>
                    </p>
                </div>-->
            </div>
